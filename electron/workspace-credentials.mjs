...
export const WORKSPACE_CREDENTIALS = [
  ...
  { section: "tts", field: "key", name: "ttsKey", env: "JLFBOT_TTS_KEY" },
  { section: "tts", field: "fishKey", name: "fishAudioKey", env: "JLFBOT_FISH_AUDIO_API_KEY" },
  { section: "imageGen", field: "key", name: "openaiImageApiKey", env: "JLFBOT_OPENAI_IMAGE_KEY" },
  { section: "imageGen", field: "customApiKey", name: "customImageApiKey", env: "JLFBOT_CUSTOM_IMAGE_KEY" },
