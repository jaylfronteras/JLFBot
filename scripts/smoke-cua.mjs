...
const resources = process.env.JLFBOT_CUA_RESOURCES ?? join(root, "dist-native", hostArch);
process.env.JLFBOT_CUA_SDK_LIBRARY = join(resources, "cua-sdk/native/libcua_driver_sdk.dylib");
...
const host = new EmbeddedCuaDriverHost(binary, "com.jlfbot.app");
let proxy;
...
try {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "jlfbot-package-smoke", version: "1" },
  });
