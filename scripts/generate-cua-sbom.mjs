...
function registryComponent(pkg, cargoLockPackages) {
  ...
  return {
    ...
    properties: [
      { name: "jlfbot:cargo:package-id", value: pkg.id },
      { name: "jlfbot:cargo:crate-sha256", value: locked.checksum },
    ],
  };
}
...
function interComponent() {
  return {
    ...
    properties: [
      {
        name: "jlfbot:font:name-table-version",
        value: "Version 4.001;git-66647c0bb",
      },
      { name: "jlfbot:font:embedded-sha256", value: INTER_FONT_SHA256 },
    ],
  };
}
...
<head>
  ...
  <title>JLFBot — Cua Driver third-party licenses</title>
...
const bom = {
  ...
  metadata: {
    component: {
      ...
      properties: [
        { name: "jlfbot:archive:sha256", value: ARCHIVE_SHA256 },
        { name: "jlfbot:cargo-lock:sha256", value: CARGO_LOCK_SHA256 },
        { name: "jlfbot:target", value: "x86_64-unknown-linux-gnu" },
        { name: "jlfbot:feature", value: "cua-driver/portal-input" },
        {
          name: "jlfbot:registry-component-count",
          value: String(EXPECTED_REGISTRY_UNION_COUNT),
        },
        {
          name: "jlfbot:trycua-component-count",
          value: String(TRYCUA_COMPONENTS.length),
        },
        {
          name: "jlfbot:file:cua-driver:sha256",
          value:
            "ed5844fadf07b9b72c4a3b3802e1c47233c166d66d6198608d5991f807aab4ac",
        },
        {
          name: "jlfbot:file:cua-cursor-theme:sha256",
          value:
...
JLFBot redistributes two executables from the official Cua Driver ${RELEASE_VERSION} Linux x64 release: \`cua-driver\` and \`cua-cursor-theme\`.
...
The complete MPL-2.0 text and package copyright notices appear in \`THIRD_PARTY_LICENSES.html\`. These files remain under their original licenses; JLFBot's and Cua's MIT licenses do not replace them.
