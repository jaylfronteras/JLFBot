...
const binaryPath = process.env.JLFBOT_VERIFY_BROWSER_BINARY;
const executablePath = process.env.JLFBOT_VERIFY_BROWSER_CHROME;
if (!binaryPath || !executablePath) throw new Error("Set JLFBOT_VERIFY_BROWSER_BINARY and JLFBOT_VERIFY_BROWSER_CHROME to explicit installed binaries.");
