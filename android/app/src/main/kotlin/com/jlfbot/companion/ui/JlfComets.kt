...
internal data class JlfCometSpec(
    val count: Int,
...
internal object JlfComets {
    val trails: Map<JlfState, JlfCometSpec> = mapOf(
        JlfState.ORBIT to JlfCometSpec(6, 3000f, 105f, 5f, 2.5f, 0.72f),
        JlfState.RADAR to JlfCometSpec(4, 2400f, 106f, 4.5f, 2.1f, 0.72f),
        JlfState.PROGRESS to JlfCometSpec(5, 2000f, 104f, 4.8f, 2.3f, 0.74f),
        JlfState.LOADING to JlfCometSpec(5, 2400f, 105f, 5f, 2.6f, 0.72f),
        JlfState.UPLOADING to JlfCometSpec(4, 1800f, 104f, 4.8f, 2.2f, 0.74f),
    )
...
internal class JlfCometField {
    ...
    fun update(spec: JlfCometSpec, elapsedMillis: Float, centreX: Float, centreY: Float) {
        count = 0
        ...
        for (comet in 0 until spec.count) {
            ...
            for (run in 0 until runs) {
                ...
                piece.colorIndex = comet % JlfComets.colors.size
