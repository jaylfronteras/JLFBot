...
object OnboardingCopy {
    ...
    const val UNPAIRED_HOME_BODY =
        "Pair this phone with JLFBot to see your chats and respond to your bots."
    const val UNPAIRED_HOME_HINT =
        "On your computer, open JLFBot → Settings → Phone."
 ...
 * [com.jlfbot.companion.core.NotificationOnboardingPolicy].
 */
@Composable
