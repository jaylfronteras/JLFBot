...
import com.jlfbot.companion.core.ConnectedAppsRules
import com.jlfbot.companion.core.ConnectorAccount
import com.jlfbot.companion.core.ConnectorCard
import com.jlfbot.companion.core.ConnectorCatalog
import com.jlfbot.companion.core.ConnectorStatus
import com.jlfbot.companion.core.ConnectorStatuses
        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            Text(
                if (hasLastKnownInventory) {
                    "Showing what was connected last time. Your computer could not open its credential store just now, so these accounts could not be re-checked. Nothing has been disconnected — restarting JLFBot on your computer usually clears this."
                } else {
                    "Your computer could not open its credential store, so it cannot say which accounts are connected. Nothing has been disconnected — restarting JLFBot on your computer usually clears this."
                },
                color = secondaryTint,
                fontSize = 13.sp,
            )
