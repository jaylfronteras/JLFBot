package com.jlfbot.companion.notifications
...
class LocalNotificationPoster(
    ...
    override fun deliver(notification: NotificationFrame, sequence: Int?) {
        ...
        val builder = NotificationCompat.Builder(appContext, channelId)
            ...
            .setSmallIcon(R.drawable.ic_jlf_mark)
    ...
    companion object {
        const val EXTRA_THREAD_ID = "jlfbot.threadId"
        const val EXTRA_BOT_ID = "jlfbot.botId"
        const val EXTRA_KIND = "jlfbot.kind"
