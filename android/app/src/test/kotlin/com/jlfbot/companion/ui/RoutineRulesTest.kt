...
import com.jlfbot.companion.core.Instance
import com.jlfbot.companion.core.ModelCatalog
import com.jlfbot.companion.core.ProviderSnapshot
import com.jlfbot.companion.core.Routine
import com.jlfbot.companion.core.RoutineRun
import com.jlfbot.companion.core.RoutineRunAvailability
...
class RoutineRulesTest {
    ...
    fun `Cloud VM needs both the credential and an available agent`() {
        ...
        assertTrue(RoutineRules.cloudSelectable(ready, RoutineRunLocation.JLF))
        assertFalse(RoutineRules.cloudSelectable(noAgent, RoutineRunLocation.JLF))
    }
    ...
    fun `an existing cloud routine keeps its choice while the VM is away`() {
        ...
        assertFalse(RoutineRules.cloudSelectable(null, RoutineRunLocation.JLF))
    }
    ...
    fun `the run-location footer says what the choice actually means`() {
        ...
        assertEquals(
            RoutineRules.JLF_FOOTER,
            RoutineRules.locationFooter(RoutineRunLocation.JLF, blocked),
        )
        assertEquals(
