...
import com.jlfbot.companion.core.NotificationAuthorizationState
import com.jlfbot.companion.core.OnboardingPairingState
...
import com.jlfbot.companion.ui.notificationAuthorization
import com.jlfbot.companion.ui.onboardingPairingState
import com.jlfbot.companion.ui.OnboardingCopy
...
class OnboardingRoutingTest {
    ...
    fun `a deep link opens pairing even on a first launch nobody has answered`() {
        ...
        scene.session.receivePairingURL(
            "jlfbot://pair?address=127.0.0.1:8810&code=123456",
        )
        compose.waitForIdle()
