...
//     JLFBOT_KEYSTORE_FILE, JLFBOT_KEYSTORE_PASSWORD,
//     JLFBOT_KEY_ALIAS, and optionally JLFBOT_KEY_PASSWORD.
//
...
private val storeFilePath = signingMaterial("storeFile", "JLFBOT_KEYSTORE_FILE")
private val storePasswordValue = signingMaterial("storePassword", "JLFBOT_KEYSTORE_PASSWORD")
private val keyAliasValue = signingMaterial("keyAlias", "JLFBOT_KEY_ALIAS")
...
private val keyPasswordValue =
    signingMaterial("keyPassword", "JLFBOT_KEY_PASSWORD") ?: storePasswordValue
...
private val releaseSigningMaterial = mapOf(
    "storeFile / JLFBOT_KEYSTORE_FILE" to storeFilePath,
    "storePassword / JLFBOT_KEYSTORE_PASSWORD" to storePasswordValue,
    "keyAlias / JLFBOT_KEY_ALIAS" to keyAliasValue,
)
...
android {
    namespace = "com.jlfbot.companion"
    compileSdk = 37
