...
class DecodingTest {
    ...
    fun decodesThePairResponse() {
        ...
        assertTrue(paired.token.startsWith("jlf_"))
    ...
    fun malformedAdvisoryEndpointDoesNotDiscardAPairedToken() {
        ...
        assertEquals("jlf_device", paired.token)
    ...
    fun nonArrayAdvisoryEndpointsAreExplicitlyDiscardedWithoutLosingTheToken() {
        val paired = CompanionJson.decodeFromString<PairResponse>(
            """{"token":"jlf_device","device":{"id":"d1","name":"Pixel","createdAt":1,"lastSeenAt":1},"serverName":"Mac","hosts":["192.168.1.42"],"endpoints":{"url":"https://mac.example"}}""",
        )
