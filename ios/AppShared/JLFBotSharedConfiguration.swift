...
enum JLFBotSharedConfiguration {
    static let appGroupIdentifier = "group.com.jlfbot.shared"
    static let legacyAppBundleIdentifier = "com.jlfbot.app"
    static let keychainAccessGroupInfoKey = "JLFBotKeychainAccessGroup"
