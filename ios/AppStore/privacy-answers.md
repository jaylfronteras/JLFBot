...
- Privacy policy URL:
  `https://github.com/jaylfronteras/JLFBot/blob/main/docs/ios-privacy.md`
...
companion computer, and local Wi-Fi and Tailscale pairing require no JLFBot
...
**Send**. They are written to that computer's local JLFBot attachments
