...
extension JlfState {
    ...
    private static let legacy: [String: JlfState] = [
    ...
    static func normalize(_ value: String?) -> JlfState? {
        guard let value, !value.isEmpty else { return nil }
        return JlfState(rawValue: value) ?? legacy[value]
    }

    static func forBot(_ bot: Bot, last: Message?) -> JlfState {
    ...
    static func forChat(_ chat: Chat, in state: CompanionState) -> JlfState {
        switch chat {
