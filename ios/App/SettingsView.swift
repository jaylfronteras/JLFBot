    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Alerts arrive while JLFBot is open or was recently in the background. Closed-app delivery is not available yet.")
            }
            ...
            Section {
                ...
                Text("Changes the language inside JLFBotMobile. Buttons drawn by iOS itself follow the phone's language, which you can set for this app in iOS Settings.")
            }
        ...
        HStack(spacing: 12) {
            ZStack {
                RoundedRectangle(cornerRadius: 10, style: .continuous)
                    .fill(JlfPalette.color("blue").opacity(0.14))
                    .frame(width: 38, height: 38)
                Image(systemName: "laptopcomputer")
                    .foregroundStyle(JlfPalette.color("blue"))
            }
            ...
            if !otherComputers.isEmpty {
                Section("Other computers") {
                    ForEach(otherComputers) { computer in
                        ...
                        .accessibilityHint("Switches JLFBotMobile to this computer")
                    }
                }
            }
...
struct ConnectionSecurityView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("This removes the connection from this device only. It does not revoke this device on your Mac. To remove Mac-side access, open JLFBot → Settings → Phone and remove it there.")
        }
    }
    ...
    private var troubleshootingText: Text {
        ...
        case .connecting:
            return Text("JLFBot is trying the saved connection automatically.")
