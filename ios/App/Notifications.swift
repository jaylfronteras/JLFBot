...
final class NotificationCoordinator: NSObject, UNUserNotificationCenterDelegate {
    ...
    func deliver(_ notification: NotificationFrame, sequence: Int?) {
        ...
        content.categoryIdentifier = notification.isBlocking ? "JLFBOT_APPROVAL" : "JLFBOT_UPDATE"
        ...
        let identifier = "jlfbot.\(notification.threadId).\(sequence.map(String.init) ?? notification.title)"
