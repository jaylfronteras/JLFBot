...
struct CompanionWelcomeView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 28) {
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 32, style: .continuous)
                        .fill(JlfPalette.color("blue").opacity(0.12))
                        .frame(width: 148, height: 148)
                    JlfAvatar(color: "blue", size: 108, state: .happy, animated: false)
        ...
        .background {
            LinearGradient(
                colors: [JlfPalette.color("blue").opacity(0.10), Color.clear],
                startPoint: .top,
                endPoint: .center
            )
            .ignoresSafeArea()
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        Text("Connect when you're ready")
                            .font(.title2.bold())
                        Text("Pair this device with JLFBot to see your chats and respond to your bots.")
                            .foregroundStyle(.secondary)
                            .multilineTextAlignment(.center)
                            .fixedSize(horizontal: false, vertical: true)
                    }

                    Text("On your computer, open JLFBot → Settings → Phone.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
            ...
            VStack(spacing: 10) {
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 30, style: .continuous)
                        .fill(JlfPalette.color("green").opacity(0.12))
                        .frame(width: 132, height: 132)
                    Image(systemName: "bell.badge.fill")
                        .font(.system(size: 48, weight: .medium))
                        .foregroundStyle(JlfPalette.color("green"))
                }
                .accessibilityHidden(true)
                ...
                VStack(spacing: 10) {
                    Text("Stay in the loop")
                        .font(.largeTitle.bold())
                    Text("Get alerts while JLFBot is open or was recently in the background. Alerts stop after iOS fully suspends or closes the app.")
                        .font(.title3)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .fixedSize(horizontal: false, vertical: true)
