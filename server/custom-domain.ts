...
const DESCRIPTOR_PATH = "/.well-known/jlfbot/environment";
export const CUSTOM_DOMAIN_CHALLENGE_PATH = "/.well-known/jlfbot/domain-check/";
...
export function customDomainIpv4(
  ...
  configured = process.env.JLFBOT_PUBLIC_IPV4,
): string | null {
  if (configured?.trim()) {
