...
import type { JlfColor } from "./store.ts";
...
export const BOT_PACKAGE_FORMAT = "jlfbot.package" as const;
...
const COLORS = [
  ...
  "teal",
  "coral",
] as const satisfies readonly JlfColor[];
...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an JLFBot package" }),
 ...
 * run without JLFBot or another proprietary parser. */
