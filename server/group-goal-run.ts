...
export const GROUP_GOAL_CONTROL_OPEN = "<jlfbot-goal>";
export const GROUP_GOAL_CONTROL_CLOSE = "</jlfbot-goal>";
...
export function groupGoalWorkerInstructions(args: {
  ...
  return [
    ...
    `Address your result to ${args.coordinatorName}. Do not invent a new orchestration protocol or emit an jlfbot-goal control envelope.`,
  ].join("\n");
}
