...
export const TEAM_LIBRARY_REPOSITORY = "https://github.com/jaylfronteras/jlfbot-teams";
export const TEAM_LIBRARY_RAW_ROOT = "https://raw.githubusercontent.com/jaylfronteras/jlfbot-teams/main";
...
export function parseTeamCatalog(value: unknown): TeamCatalog {
  if (!isRecord(value) || value.format !== "jlfbot.catalog" || value.version !== 1) {
  ...
  const teams = value.teams.map((raw, index): TeamCatalogEntry => {
    ...
    return {
      ...
      ...(raw.package !== undefined
        ...
        : {}),
      manifest: relativeFile(raw.manifest, `${field}.manifest`, ".jlfteam.json", prefix),
  ...
  if (url.hostname === "github.com" || url.hostname === "www.github.com") {
    if (parts.length === 2) {
      ...
      return [
        ...
        `https://raw.githubusercontent.com/${owner}/${repo}/main/team.jlfteam.json`,
        `https://raw.githubusercontent.com/${owner}/${repo}/master/botmrr.md`,
        `https://raw.githubusercontent.com/${owner}/${repo}/master/team.md`,
        `https://raw.githubusercontent.com/${owner}/${repo}/master/team.jlfteam.json`,
      ];
    }
