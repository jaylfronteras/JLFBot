...
// JLFBOT_DATA_DIR is an intentional production override, but tests must never
// let it escape the throwaway home they are about to delete.
delete process.env.JLFBOT_DATA_DIR;
...
process.env.JLFBOT_COMPANION_DIR = join(home, ".jlfbot-companion");
