...
//     reads JLFBot's temporary `jlfbot-agents` entry from agy's
...
function agentsMcpEntry(): McpEntry | null {
  ...
  try {
    ...
    const entry = config.mcpServers?.["jlfbot-agents"];
  ...
  return new Promise((resolve, reject) => {
    ...
    write({
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "jlfbot-fake-antigravity", version: "1.0.0" },
      },
    });
  });
}
