...
const service: ServiceInfo = {
  ...
  type: "_jlfbot._tcp",
  port: 8800,
  host: "jlfbot-1a2b3c4d.local",
  addresses: ["192.168.1.42"],
  txt: ["v=1", "name=Milind's computer"],
};

const INSTANCE = "Milind's computer._jlfbot._tcp.local";
const SERVICE_NAME = "_jlfbot._tcp.local";
