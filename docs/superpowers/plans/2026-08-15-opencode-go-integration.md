...
**Goal:** Add OpenCode Go as an optional ACP-backed JLFBot engine with dynamic models, write-only credentials, setup UX, and comprehensive tests.
...
- [ ] Add cross-platform setup commands, docs URL, and a login note that never asks JLFBot to edit OpenCode auth files.
