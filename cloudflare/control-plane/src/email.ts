...
const SUBJECTS = {
  "sign-in": "Your JLFBot sign-in code",
  "email-verification": "Verify your JLFBot email",
  "forget-password": "Reset your JLFBot password",
  "change-email": "Confirm your JLFBot email change",
