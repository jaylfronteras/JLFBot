...
```bash
pnpm docs:build
pnpm --filter @jlfbot/docs types:check
...
5. Add `docs.jlfbot.example.com` under **Settings → Domains**.
...
preview URLs for documentation pull requests. Keep `jlfbot.example.com` on the
